...
def mergeImages(im1, im2, transf):
    ...
    mask2warp = warp(mask2, (offset1 + t2).inverse, output_shape=output_shape)
    overlap = np.logical_and(mask1warp, mask2warp)

    merged = im1warp + im2warp
    merged[overlap] = im1warp[overlap]
    return merged


if __name__ == '__main__':
    im1 = imread("../data/stitching/eg_1.jpg")
    im2 = imread("../data/stitching/eg_2.jpg")
